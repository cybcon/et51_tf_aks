...
resource "azurerm_virtual_machine" "adminhost" {
  ...
  os_profile_linux_config {
    ...
    # Thomas Storch
    ssh_keys {
      key_data = "ssh-rsa  thomas.storch@bridging-it.de\n"
      path     = "/home/tfuser/.ssh/authorized_keys"
    }
  }
}
